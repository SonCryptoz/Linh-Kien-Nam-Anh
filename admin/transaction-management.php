            ...
            <div class="row">
                <div class="col-12">
                    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="incompleted-nav" data-toggle="pill" href="#incompleted-tab"
                            role="tab"><i class="fa fa-shopping-bag"></i>Đơn hàng chưa hoàn thành</a>
                        <a class="nav-link " id="completed-nav" data-toggle="pill" href="#completed-tab" role="tab"><i
                                class="fa fa-shopping-bag"></i>Đơn hàng đã xử lý</a>
                ...
                <div class="col-12">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="incompleted-tab" role="tabpanel"
                            aria-labelledby="incompleted-nav">
