...
<body>
    ...
    <div class="cart-page">
        ...
        try {
            ...
            echo "<h4 style='text-align: center; font-size: 18px; font-weight: 600; margin-bottom: 0px;'>Mã đơn hàng: " . $id_transaction . "</h4>";
            echo "</div>";
            echo "</div>";
            echo "<div class='col-lg-12'>";
            ...
            for ($count = 0; $count < count($productArray); $count++) {
                ...
                if (!$rs1 || $rs1->num_rows == 0) {
                    throw new Exception("Không thể hiển thị đơn hàng do sản phẩm đã thay đổi hoặc bị xóa khỏi hệ thống.");
                }
            ...
            $shipCost = 35000;
            echo "<td><p class='title-checkout-text' style='margin: 5px 0px;'>(Phí ship: " . moneyPoint($shipCost) . "đ)</p>
            ...
            echo "<script>alert('" . $e->getMessage() . "'); window.location.href = 'transaction-management.php';</script>";
        }
        ?>
    </div>
    <!-- Cart End -->
