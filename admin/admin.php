                        ...
                        <div class="header__navbar-item header__navbar-user">
                            ...
                            <ul class="header__navbar-user-menu">
                                <li class="header__navbar-user-item header__navbar-user-item--separate">
                                    <a href="logout.php" onclick="return confirm('Bạn có chắc chắn muốn đăng xuất?');">Đăng xuất</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="admin-list-nav" data-toggle="pill" href="#admin-list-tab"
                            role="tab">Danh sách Admin</a>
                        <a class="nav-link" id="new-admin-nav" data-toggle="pill" href="#new-admin-tab" role="tab">Thêm
                            Admin</a>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="admin-list-tab" role="tabpanel"
                            aria-labelledby="admin-list-nav">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" type="text" name="authority"
                                            placeholder="1: Admin, 2: Nhân viên">
                                    </div>
                                    <div class="col-md-12">
