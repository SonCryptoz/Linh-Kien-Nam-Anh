    ...
    <div class="bottom-bar">
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <form method="get" action="view-product-list.php?" class="col-md-4">
                    <div class="search">
                ...
                <div class="col-md-2">
                    <div class="user">
                        <a href="view-product-list.php" class="btncartindex">
                ...
                <div class="col-md-2">
                    <div class="user">
                        <a href="" onclick="mustInput();" class="btncartindex">
                            <div class="icon-container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <nav class="navbar bg-light">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Case+máy+tính"><i
                                        class="bi bi-pc"></i>Case máy tính</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Main"><i
                                        class="bi bi-pci-card"></i>Mainboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Vi+xử+lý"><i
                                        class="bi bi-cpu"></i>Vi xử lý</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=RAM"><i
                                        class="fas fa-microchip"></i>RAM</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=VGA"><i
                                        class="bi bi-gpu-card"></i>Card đồ họa</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=SSD"><i
                                        class="bi bi-hdd"></i>Ổ cứng SSD</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=HDD"><i
                                        class="bi bi-hdd"></i>Ổ cứng HDD</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Màn+hình"><i
                                        class="bi bi-display"></i>Màn hình</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Chuột"><i
                                        class="bi bi-mouse2"></i>Chuột</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Bàn+phím"><i
                                        class="bi bi-keyboard"></i>Bàn phím</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Tai+nghe"><i
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Tản+nhiệt"><i
                                        class="fas fa-fan"></i>Tản nhiệt</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Loa"><i
                                        class="bi bi-speaker"></i>Loa</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Thiết+bị+mạng"><i
                                        class="bi bi-router"></i>Thiết bị mạng</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Camera"><i
                                        class="bi bi-webcam"></i>Camera</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="view-product-list.php?page_num=1&search=Phụ+kiện+khác"><i
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="category-item ch-250">
                        ...
                        <a class="category-name" href="view-product-list.php?search=main">
                            <p>MAINBOARD</p>
                        </a>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="category-item ch-400">
                        ...
                        <a class="category-name" href="view-product-list.php?search=bàn+phím">
                            <p>KEYBOARD</p>
                        </a>
                    </div>
                </div>
